...
use Calculus\Database\Fluent\Exception\EntityManagerClosed;
use Calculus\Database\Fluent\Exception\InvalidHydrationMode;
use Calculus\Database\Fluent\Exception\MismatchedEventManager;
use Calculus\Database\Fluent\Exception\MissingIdentifierField;
use Calculus\Database\Fluent\Exception\MissingMappingDriverImplementation;
use Calculus\Database\Fluent\Exception\NotSupported;
use Calculus\Database\Fluent\Exception\ORMException;
use Calculus\Database\Fluent\Exception\UnrecognizedIdentifierFields;
...
use Calculus\Database\Fluent\Query\Expr;
use Calculus\Database\Fluent\Query\FilterCollection;
 ...
 * should take a look at the {@see \Calculus\Database\Fluent\Decorator\EntityManagerDecorator}
